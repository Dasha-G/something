...
from instructions import txt_instruction, txt_test1, txt_test3, txt_sits, ttimer
...
Window.clearcolor = (0.4,0.5,0.6,0.8)
btn_color = (0.44, 0.65, 0.8, 1)
...
class InstrScr(Screen):
    def __init__(self, **kwargs):
        ...
        instr = Label(text=txt_instruction, text_size=(300, 350))
        lbl1 = Label(text="Введіть ім'я:", halign="right")
        self.in_name = TextInput(multiline=False)
        lbl2 = Label(text="Введіть вік:", halign="right")
        self.in_age = TextInput(text="7", multiline=False)
        self.btn = Button(text="Почати", size_hint=(0.4, 0.1), pos_hint={"center_x": 0.5})
...
class PulseScr(Screen):
  def __init__(self, **kwargs):
      ...
      line = BoxLayout(size_hint=(1, None), height='30sp')
      ...
      self.btn = Button(text='Почати', size_hint=(0.4, 0.2), pos_hint={'center_x': 0.5})
      self.btn.background_color = btn_color
      self.btn.on_press = self.next
      outer = BoxLayout(orientation='vertical', padding=8, spacing=8)
      outer.add_widget(instr)
...
class CheckSits(Screen):
    def __init__(self, **kwargs):
        ...
        instr = Label(text=txt_sits, size_hint=(0.5, 1),text_size=(100,200))
...
class PulseScr2(Screen):
  def __init__(self, **kwargs):
      ...
      self.stage = 0
      super().__init__(**kwargs)
      instr = Label(text=txt_test3,text_size=(300,200))
      line1 = BoxLayout(size_hint=(1, None), height='30sp')
      self.lbl_sec = Seconds(15)
      self.lbl_sec.bind(done=self.sec_finished)
      ...
      lbl_result2 = Label(text=ttimer, halign='right')
...
class Result(Screen):
    def __init__(self, **kwargs):
        ...
        self.instr = Label(text="",text_size=(200,300))
